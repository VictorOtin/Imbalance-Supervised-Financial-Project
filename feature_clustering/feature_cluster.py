...
# -*- coding: utf-8 -*-
"""
Created on Sun May 30 13:07:20 2021
...
from feature_clustering.onc import *
from feature_clustering.codependence_matrix import *
from feature_clustering.denoise_detone import *

# pylint: disable=invalid-name
def get_feature_clusters(X: pd.DataFrame,q: int, dependence_metric: str, detone:bool = False, distance_metric: str = None,
    ...
    #Here denoise and optionally detone
    dep_matrix = pd.DataFrame(denoise_and_detone(dep_matrix,q,detone = False),index = list(col), columns = list(col))

    #Onc algo
    cluster_obj = get_onc_clusters(dep_matrix.fillna(0))
    ...
    #Plot matrix with ONC
    plt.subplots(figsize=(10,10))   
    sns.heatmap(cluster_obj[0])
    
    #Plot correlation matrix with hirarchical clustering
    sns.clustermap(dep_matrix)
    
    return cluster_obj[1] 
